    ...
    <div class="row mt-5">
        <div class="col-12 col-md-6 col-lg-5 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="IdEstacion">Estacion a la que se agregará</label>
                        <asp:DropDownList ID="IdEstacion" CssClass="form-control" runat="server"></asp:DropDownList>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="IdeTxt">Identificador Punto de Carga</label>
                        ...
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator" CssClass="text-danger"
                            ControlToValidate="IdeTxt" OnServerValidate="CustomValidator1_ServerValidate" ValidateEmptyText="true"></asp:CustomValidator>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox runat="server" Type="number" min="1" max="10" ID="CapMaxTxt" CssClass="form-control" MaxLength="1"></asp:TextBox>
